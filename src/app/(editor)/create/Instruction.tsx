...
export default function Instruction() {
  const displayInstructions = useInstructionStore(
    (state) => state.displayInstructions,
  );
      ...
      <div className="space-y-6">
        ...
        <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 rounded-xl p-8 text-center">
          ...
          <p className="text-sm text-[var(--color-editor-secondary)] max-w-md mx-auto">
            A quick tour to help you get the most out of the editor. This only
            takes a minute!
          </p>
        </div>
        ...
        <div className="bg-[var(--color-editor-surface)] rounded-xl p-6 border border-[var(--color-editor-border)]">
          ...
          <p className="text-sm text-[var(--color-editor-secondary)] leading-relaxed mb-3">
            OpenIdear is an open platform where everyone can share ideas,
            knowledge, services, and technology. We connect a creative community
            and support earning through affiliate links.
          </p>
        ...
        <div className="bg-[var(--color-editor-surface)] rounded-xl overflow-hidden border border-[var(--color-editor-border)]">
            ...
            <div className="flex gap-6">
              <div className="flex-1 space-y-3">
                ...
                <p className="text-xs text-[var(--color-editor-secondary)] leading-relaxed">
                  Click the sidebar icon to browse your existing posts or create
                  a new one.
                </p>
              </div>
              ...
              <div className="flex-1 space-y-3">
                ...
                <p className="text-xs text-[var(--color-editor-secondary)] leading-relaxed">
                  Use the + button below the editor to insert blocks like
                  headings, images, code, and more.
                </p>
              </div>
            </div>
          </div>
          <div className="bg-[var(--color-editor-elevated)] px-6 py-3">
            <p className="text-xs text-[var(--color-editor-muted)] text-center">
              💡 Tip: You can also drag and drop images directly into the
              editor!
            </p>
          </div>
        </div>
          ...
          {[
            {
              ...
              desc: "Use the toolbar to format text — bold, italic, headings, lists, and more.",
            },
            {
              emoji: "👁️",
              title: "Live Preview",
              desc: "Toggle Preview mode to see how your post will look when published.",
            },
            {
              emoji: "💻",
              title: "HTML Mode",
              desc: "Switch to HTML mode for fine-grained control over your content.",
            },
            {
              emoji: "💾",
              title: "Auto-Save",
              desc: "Your work is automatically saved every few seconds. No more lost drafts!",
            },
          ].map((item, i) => (
            <div
              key={i}
