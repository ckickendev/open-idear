        ...
        return (
            <div className="flex h-screen items-center justify-center bg-gray-50">
                <div className="text-center max-w-md p-8">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mb-3">Bạn chưa đăng ký khóa học này</h2>
                    <p className="text-gray-500 mb-6">Vui lòng mua khóa học để truy cập nội dung học tập.</p>
                    <button
        ...
        return (
            <div className="flex h-screen items-center justify-center bg-gray-50">
                <div className="animate-pulse flex flex-col items-center">
                    ...
                    <p className="mt-4 text-gray-500 font-medium">Đang tải khóa học...</p>
                </div>
            </div>
        );
    }
                    ...
                    <div className="flex items-center gap-6">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <div className="text-sm">
                                ...
                                <div className="font-bold">{completedLessonsCount} / {totalLessonsCount} bài ({progress}%)</div>
                            </div>
                        </div>
                    </div>
                </header>
                                ...
                                >
                                    <div className="flex-1">
                                        ...
                                        <div className="text-xs text-gray-500 mt-1">
                                            {chapterCompletedCount} / {chapter.lessons?.length || 0} | 10min
                                        </div>
                                    </div>
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div className="mt-1 flex-shrink-0">
                                                        <input
                                                            type="checkbox"
                                                            className="w-4 h-4 rounded border-gray-300 text-[var(--color-admin-primary)] focus:ring-[var(--color-admin-primary)] cursor-pointer"
                                                            checked={isCompleted}
                                                            onChange={(e) => {
                                                                e.stopPropagation();
                                                                if (!isCompleted) {
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <h4 className={`text-sm leading-tight ${isCurrent ? 'font-bold text-black' : isCompleted ? 'text-gray-500' : 'text-gray-800'}`}>
