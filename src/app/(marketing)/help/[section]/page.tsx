...
function HelpCenterContent() {
  ...
  const faqs = [
    {
      q: "Làm thế nào để đăng bài viết lên OpenIdear?",
      a: 'Để đăng bài viết, nhấn vào nút "Tạo bài viết" ở góc trên bên phải sau khi đăng nhập. Nhập tiêu đề, nội dung, chọn danh mục và nhấn Đăng tải.',
    },
    {
      q: "Tôi có thể chỉnh sửa bài viết sau khi đã đăng không?",
      a: "Có, bạn có thể chỉnh sửa bài viết bất kỳ lúc nào từ trang cá nhân. Vào mục Bài viết → chọn bài → nhấn Chỉnh sửa.",
    },
    {
      q: "Làm thế nào để đặt lại mật khẩu?",
      a: 'Trên trang đăng nhập, nhấn "Quên mật khẩu?" và nhập địa chỉ email của bạn. Chúng tôi sẽ gửi link đặt lại mật khẩu trong vài phút.',
    },
    {
      q: "Tôi có thể xóa tài khoản không?",
      a: "Bạn có thể yêu cầu xóa tài khoản tại Cài đặt → Tài khoản → Xóa tài khoản. Lưu ý: thao tác này không thể hoàn tác.",
    },
  ];
    ...
    <div className="space-y-8">
      <div>
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          {topics.map((t) => (
            <SectionCard key={t.href} icon={t.icon} title={t.title} href={t.href} desc={t.desc} />
          ))}
        </div>
      </div>
...
function AntiFraudContent() {
  const tips = [
    { title: "Không chia sẻ mật khẩu", desc: "OpenIdear sẽ không bao giờ yêu cầu mật khẩu của bạn qua email hay tin nhắn." },
    { title: "Kiểm tra URL cẩn thận", desc: "Luôn đảm bảo bạn đang truy cập openidear.xyz, không phải trang giả mạo." },
    { title: "Bật xác thực 2 bước", desc: "Tăng cường bảo mật tài khoản bằng cách bật 2FA trong phần Cài đặt bảo mật." },
    { title: "Cảnh giác với đường link lạ", desc: "Không nhấn vào link từ email, tin nhắn không rõ nguồn gốc." },
    { title: "Báo cáo tài khoản nghi ngờ", desc: "Nếu thấy hành vi bất thường, hãy báo cáo ngay qua tính năng Báo cáo." },
  ];

  const warning_signs = [
    "Yêu cầu chuyển tiền hay tặng thẻ cào",
    "Cung cấp thông tin cá nhân, CMND/CCCD",
    "Nhận thưởng hay giải thưởng bất ngờ",
    "Link đăng nhập gửi qua email / SMS",
    "Tài khoản hỏi mượn thông tin ngân hàng",
  ];
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-start gap-4 p-5 bg-orange-50 dark:bg-orange-950/30 border border-orange-200 dark:border-orange-800 rounded-2xl">
        ...
        <div>
          ...
          <p className="text-sm text-orange-800 dark:text-orange-400 leading-relaxed">
            OpenIdear <strong>không bao giờ</strong> yêu cầu mật khẩu, thông tin ngân hàng hoặc mã OTP của bạn qua bất kỳ kênh nào.
          </p>
        </div>
      </div>
      ...
      <div className="text-center bg-card border border-border rounded-2xl p-6">
        ...
        <Link href="/help/bao-cao-su-co">
          <button className="bg-orange-500 hover:bg-orange-600 text-white px-6 py-2.5 rounded-xl text-sm font-semibold transition-colors">
            Báo cáo ngay
          </button>
        </Link>
      </div>
...
function AccountStatusContent() {
  const statuses = [
    {
      ...
      desc: "Tài khoản đang hoạt động bình thường. Bạn có đầy đủ quyền truy cập vào tất cả tính năng.",
    },
    {
      icon: AlertCircle,
      ...
      status: "Bị hạn chế một phần",
      desc: "Một số tính năng bị hạn chế do vi phạm chính sách. Kiểm tra email để biết thêm chi tiết.",
    },
    {
      icon: XCircle,
      color: "text-red-500",
      ...
      status: "Bị đình chỉ",
      desc: "Tài khoản tạm thời bị đình chỉ. Liên hệ bộ phận hỗ trợ để được hướng dẫn phục hồi.",
    },
  ];
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <div className="space-y-3">
          {statuses.map((s) => (
            <div
              key={s.status}
              className={`flex items-start gap-4 p-5 border rounded-2xl ${s.bg} ${s.border}`}
            >
      ...
      {/* Account info */}
      <div>
        <h3 className="text-sm font-bold uppercase tracking-widest text-muted-foreground mb-4">Thông tin tài khoản của bạn</h3>
        <div className="bg-card border border-border rounded-2xl overflow-hidden">
        ...
        <p className="text-xs text-muted-foreground mt-3 text-center">
          Đăng nhập để xem thông tin chi tiết tài khoản của bạn
        </p>
      </div>
      ...
      <div className="bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 border border-green-200 dark:border-green-800 rounded-2xl p-6 text-center">
        ...
        <p className="text-sm text-muted-foreground mb-4">
          Xác minh tài khoản để được huy hiệu xanh và quyền ưu tiên hỗ trợ
        </p>
        <Link href="/profile/settings">
          <button className="bg-green-600 hover:bg-green-700 text-white px-6 py-2.5 rounded-xl text-sm font-semibold transition-colors">
            Xác minh ngay
          </button>
        </Link>
      </div>
...
function SupportInboxContent() {
  return (
    <div className="space-y-8">
      {/* Contact methods */}
      <div>
        <h3 className="text-sm font-bold uppercase tracking-widest text-muted-foreground mb-4">Liên hệ hỗ trợ</h3>
        <div className="grid sm:grid-cols-2 gap-4">
          {[
            {
              icon: Mail,
              title: "Email hỗ trợ",
              desc: "support@openidear.xyz",
            ...
            },
            {
              ...
              desc: "Chat với nhân viên hỗ trợ",
              detail: "8:00 – 22:00 hàng ngày",
              color: "text-blue-500",
            ...
            },
            {
              ...
              desc: "Thường trong 2–4 giờ",
              detail: "Ưu tiên theo mức độ khẩn cấp",
      ...
      <div className="bg-card border border-border rounded-2xl p-6">
        ...
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
          <div>
            ...
            <select className="w-full px-4 py-2.5 rounded-xl bg-muted border border-border text-sm text-foreground outline-none focus:ring-2 focus:ring-primary/30">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-2.5 rounded-xl bg-muted border border-border text-sm text-foreground placeholder:text-muted-foreground outline-none focus:ring-2 focus:ring-primary/30"
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-foreground mb-1.5">
            ...
            <textarea
              ...
              className="w-full px-4 py-3 rounded-xl bg-muted border border-border text-sm text-foreground placeholder:text-muted-foreground outline-none focus:ring-2 focus:ring-primary/30 resize-none"
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-foreground mb-1.5">
            ...
            <div className="flex gap-3">
              {["Thấp", "Bình thường", "Cao", "Khẩn cấp"].map((p) => (
                <button
                  key={p}
                  type="button"
                  className="px-4 py-1.5 rounded-full text-xs font-medium border border-border bg-muted hover:border-primary hover:bg-primary/10 hover:text-primary transition-colors"
                >
                  {p}
                </button>
              ))}
          ...
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-2 bg-primary text-primary-foreground py-3 rounded-xl font-semibold text-sm hover:bg-primary/90 transition-colors shadow-md"
          >
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-start gap-4 p-5 bg-red-50 dark:bg-red-950/30 border border-red-200 dark:border-red-800 rounded-2xl">
        ...
        <div>
          ...
          <p className="text-sm text-red-700 dark:text-red-400">
            Nếu bạn đang gặp nguy hiểm hoặc tình huống cần hỗ trợ ngay, vui lòng liên hệ cơ quan chức năng tại địa phương.
          </p>
        </div>
      </div>
      ...
      <div>
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          {reportTypes.map((type) => (
            <button
              key={type.title}
              className="flex items-start gap-4 p-4 rounded-xl border border-border bg-card hover:border-red-300 hover:bg-red-50 dark:hover:bg-red-950/20 transition-all text-left group cursor-pointer"
            >
              ...
              <div>
                <p className="text-sm font-semibold text-foreground group-hover:text-red-600 dark:group-hover:text-red-400 transition-colors">
                  {type.title}
                </p>
      ...
      <div className="bg-card border border-border rounded-2xl p-6">
        ...
        <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
          ...
          <div>
            <label className="block text-sm font-medium text-foreground mb-1.5">
              URL hoặc ID nội dung liên quan
            </label>
            <input
              type="text"
              placeholder="https://openidear.xyz/post/..."
              className="w-full px-4 py-2.5 rounded-xl bg-muted border border-border text-sm text-foreground placeholder:text-muted-foreground outline-none focus:ring-2 focus:ring-red-400/30"
            />
          </div>
          <div>
            <label className="block text-sm font-medium text-foreground mb-1.5">
            ...
            <textarea
              rows={5}
              placeholder="Mô tả chi tiết sự cố, bao gồm thời gian xảy ra, các bên liên quan và bằng chứng nếu có..."
              className="w-full px-4 py-3 rounded-xl bg-muted border border-border text-sm text-foreground placeholder:text-muted-foreground outline-none focus:ring-2 focus:ring-red-400/30 resize-none"
            />
          </div>
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-2 bg-red-500 hover:bg-red-600 text-white py-3 rounded-xl font-semibold text-sm transition-colors shadow-md"
          >
...
export async function generateStaticParams() {
  return [
    { section: "trung-tam-tro-giup" },
    { section: "ngan-chan-lua-dao" },
    { section: "trang-thai-tai-khoan" },
    { section: "hop-thu-ho-tro" },
    { section: "bao-cao-su-co" },
  ];
}
...
export async function generateMetadata({
  ...
  if (!data) return { title: "Trợ giúp — OpenIdear" };
  return {
    title: `${data.title} — OpenIdear`,
