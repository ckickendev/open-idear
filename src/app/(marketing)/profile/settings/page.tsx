...
const SettingsSection: React.FC<{
  ...
  <div className="bg-background dark:bg-card rounded-2xl border border-border dark:border-border overflow-hidden">
...
const FieldRow: React.FC<{
  ...
  <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-4 py-4 border-b border-border dark:border-border/50 last:border-0">
    <label className="text-sm font-medium text-muted-foreground dark:text-muted-foreground pt-2">
      {label}
    </label>
...
export default function ProfileSettingsPage() {
  ...
  const inputClass =
    "w-full px-3.5 py-2.5 text-sm bg-background dark:bg-accent border border-border dark:border-border rounded-xl focus:outline-none focus:ring-2 focus:ring-ring/40 focus:border-primary dark:focus:border-primary text-foreground dark:text-white transition-all placeholder:text-muted-foreground dark:placeholder:text-muted-foreground";
  const readonlyClass =
    "w-full px-3.5 py-2.5 text-sm bg-muted/30 dark:bg-accent/50 border border-border dark:border-border rounded-xl text-muted-foreground dark:text-muted-foreground cursor-not-allowed";
            ...
            {editingProfile ? (
              <>
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-5 py-2.5 bg-muted dark:bg-accent hover:bg-muted dark:hover:bg-accent text-foreground/80 dark:text-muted-foreground/70 text-sm font-medium rounded-xl transition-colors cursor-pointer"
                >
                  <X size={14} /> Cancel
                </button>
              </>
          ...
          {[
            {
              ...
              desc: "Receive updates about your courses and posts via email",
            },
            {
              key: "push" as const,
            ...
            <div
              key={item.key}
              className="flex items-center justify-between py-3 border-b border-border dark:border-border/50 last:border-0"
            >
              <div>
