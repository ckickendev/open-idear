    ...
    return (
        <>
            <button type="button" className="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center cursor-pointer dark:hover:bg-gray-600 dark:hover:text-white" data-modal-hide="static-modal" onClick={() => setIsAuthenFromDisplay(0)}>
                ...
                <span className="sr-only">{t("component.authen.forgotPass.close")}</span>
            </button>
                            ...
                            <div>
                                ...
                                <div className="mt-1">
                                    <input id="account" required
                                        ...
                                        placeholder={t("component.authen.forgotPass.content_placeholder")}
                                        {...register("account")} />
                        ...
                        <div className="mt-6">
                            <div className="mt-4 text-center">
                                <p className="text-gray-500 text-sm">
                                    ...
                                    <span onClick={() => setAuthenState(1)} className="text-blue-500 font-medium hover:underline cursor-pointer">{t("component.authen.forgotPass.login_now")}</span>
                                </p>
                            </div>
                        </div>
                    </div>
