...
export default function Banner() {
  ...
  return (
    <>
      {/* <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-muted/30 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
 ...
 <a href="#"className="flex-none rounded-full bg-background px-3.5 py-1 text-sm font-semibold text-white shadow-xs hover:bg-accent focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-900">Register now <span aria-hidden="true">&rarr;</span></a>
 </div>
 <div className="flex flex-1 justify-end">
 <button type="button"className="-m-3 p-3 focus-visible:outline-offset-[-4px]">
 <span className="sr-only">Dismiss</span>
 <svg className="size-5 text-foreground"viewBox="0 0 20 20"fill="currentColor"aria-hidden="true"data-slot="icon">
 <path d="M6.28 5.22a.75.75 0 0 0-1.06 1.06L8.94 10l-3.72 3.72a.75.75 0 1 0 1.06 1.06L10 11.06l3.72 3.72a.75.75 0 1 0 1.06-1.06L11.06 10l3.72-3.72a.75.75 0 0 0-1.06-1.06L10 8.94 6.28 5.22Z"/>
      ...
      <section className="relative overflow-hidden w-full flex flex-col items-center">
        <div className="w-full relative aspect-[16/5] sm:aspect-[21/9]">
          ...
          <div className="absolute inset-0 bg-transparent dark:bg-black/60 transition-colors duration-300 z-0" />
        </div>
        <div className="absolute inset-0 flex flex-col flex-nowrap justify-center items-center gap-4 max-w-screen-xl mx-auto w-full h-full z-10">
          ...
          <a
            href="./create"
            className="flex items-center gap-2 py-3.5 px-7 bg-blue-600 shadow-md text-white font-semibold hover:bg-red-600"
          >
            {t("component.banner.create")}
            <svg
              width="17"
              height="12"
              viewBox="0 0 17 12"
