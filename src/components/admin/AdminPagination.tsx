...
const AdminPagination = ({
  ...
  const inactiveBtn =
    "text-muted-foreground bg-background border border-border hover:bg-muted/30 hover:border-border cursor-pointer";
  const disabledBtn =
    "text-muted-foreground/70 bg-muted/30 border border-border cursor-not-allowed cursor-pointer";
