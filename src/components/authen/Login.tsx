                    ...
                    <div className="mt-6 grid grid-cols-3 gap-3">
                        <div className="h-full">
                            <a href="#"
                                ...
                                <Image src="https://www.svgrepo.com/show/512120/facebook-176.svg" alt="facebook logo image" width={20} height={20} />
                            </a>
                        </div>
                        <div className="h-full">
                            <a href="#"
                                className="h-full w-full flex items-center justify-center px-8 py-3 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                                <Image src="https://www.svgrepo.com/show/513008/twitter-154.svg" alt="twitter logo image" width={20} height={20} />
                            </a>
                        </div>
                        <div className="h-full">
                            <a href="#"
                                className="h-full w-full flex items-center justify-center px-8 py-3 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
                                <Image src="https://www.svgrepo.com/show/506498/google.svg" alt="google logo image" width={20} height={20} />
                            </a>
                        </div>
                    </div>
                </div>
