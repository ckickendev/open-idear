const LoadingComponent = ({ isLoading, isFullScreen }: any) => {
  ...
  const containerClasses = isFullScreen
    ? "fixed inset-0 z-[100] bg-background/80 backdrop-blur-md flex items-center justify-center"
    : "absolute inset-0 z-10 bg-background/70 backdrop-blur-sm flex items-center justify-center rounded-inherit";
