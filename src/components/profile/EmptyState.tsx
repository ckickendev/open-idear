...
const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  const defaults: Record<
    string,
    { title: string; description: string; ctaText: string; ctaHref: string }
  > = {
    courses: {
      title: "No courses yet",
      description:
        "You haven't enrolled in any courses. Start exploring to find something you love!",
    ...
    saved: {
      ...
      description:
        "Bookmark posts, series, or courses to easily find them later.",
    ...
    analytics: {
      ...
      description:
        "Create and publish courses to start seeing your analytics here.",
    ...
    posts: {
      title: "No posts yet",
      description:
        "You haven't written any posts. Share your knowledge with the community!",
    ...
    series: {
      title: "No series yet",
      description:
        "Create a series to organize your content into structured learning paths.",
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
      ...
      <p className="text-muted-foreground dark:text-muted-foreground max-w-sm mb-6 text-sm leading-relaxed">
