    ...
    <>
      ...
      >
        ...
        <span className="sr-only">
          {t("component.authen.confirm_signup.close")}
        </span>
      </button>
      ...
      <div className="max-w-md mx-auto text-center py-10 rounded-xl">
        <form id="otp-form">
          <div className="flex items-center justify-center gap-2">
            <input
              type="text"
              className="w-14 h-14 text-center text-2xl font-extrabold text-foreground bg-background border border-transparent hover:border-border appearance-none rounded p-4 outline-none focus:bg-background focus:border-primary focus:ring-2 focus:ring-ring"
              pattern="\d*"
              maxLength={1}
          ...
          <div className="max-w-[260px] mx-auto mt-4">
            <button
              ...
              onClick={onSubmit}
              ref={submit}
              className="w-full inline-flex justify-center whitespace-nowrap rounded-lg bg-indigo-500 px-3.5 py-2.5 text-sm font-medium text-white shadow-sm shadow-indigo-950/10 hover:bg-indigo-600 focus:outline-none focus:bg-red focus:ring focus:ring-ring focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300 transition-colors duration-150"
            >
              Verify
              {t("component.authen.confirm_signup.account")}
            </button>
          </div>
        </form>
        <div className="text-sm text-muted-foreground mt-4">
          {t("component.authen.confirm_signup.did")}{" "}
          <a
            className="font-medium text-indigo-500 hover:text-indigo-600"
            href="#0"
          >
            {t("component.authen.confirm_signup.resend")}
          </a>
        </div>
      </div>
    </>
