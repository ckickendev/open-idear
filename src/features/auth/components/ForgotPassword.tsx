  ...
  return (
    <>
      <button
        ...
        onClick={() => setIsAuthenFromDisplay(0)}
      >
        <svg
          className="w-3 h-3"
          aria-hidden="true"
        ...
        <span className="sr-only">
          {t("component.authen.forgotPass.close")}
        </span>
      </button>
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-extrabold text-foreground">
          {t("component.authen.forgotPass.title")}
        </h2>
      </div>
            ...
            <div className="bg-background py-8 px-4 shadow sm:rounded-lg sm:px-10">
              ...
              >
                <div>
                  <label
                    htmlFor="email"
                    className="block text-sm font-medium text-foreground/80 text-lg"
                  >
                    {t("component.authen.forgotPass.content")}
                  </label>
                  <div className="mt-1">
                    <input
                      id="account"
                      required
                      className="appearance-none rounded-md relative block w-full px-3 py-2 border border-border placeholder-gray-500 text-foreground focus:outline-none focus:ring-ring focus:border-primary focus:z-10 sm:text-sm"
                      placeholder={t(
                        "component.authen.forgotPass.content_placeholder",
                      )}
                      {...register("account")}
                    />
                    {errors.account && (
                ...
                <div>
                  ...
                  >
                    {t("component.authen.forgotPass.sendEmail")}
                  </button>
                </div>
              </form>
              <div className="mt-6">
                <div className="mt-4 text-center">
                  <p className="text-muted-foreground text-sm">
                    {t("component.authen.forgotPass.have")}
                    <span
                      onClick={() => setAuthenState(1)}
                      className="text-blue-500 font-medium hover:underline cursor-pointer"
                    >
                      {t("component.authen.forgotPass.login_now")}
                    </span>
                  </p>
                </div>
              </div>
          ...
          <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
            <div className="bg-background py-8 px-4 shadow sm:rounded-lg sm:px-10">
              ...
              <p className="text-muted-foreground text-center my-4">
                {"We have send email to" + emailSent}{" "}
              </p>
              <p className="text-muted-foreground text-center my-4">
