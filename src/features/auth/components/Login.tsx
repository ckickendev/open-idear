...
const Login = ({
  ...
  const setCurrentUserId = authenticationStore(
  ...
  return (
    <>
      <button
        ...
        onClick={() => setIsAuthenFromDisplay(false)}
      >
        <svg
          className="w-3 h-3"
          aria-hidden="true"
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  placeholder={t(
                    "component.authen.login.useroremail_placeholder",
                  )}
                  {...register("account")}
                />
                {errors.account && (
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  ...
                  name="remember_me"
                  type="checkbox"
                  className="h-4 w-4 text-indigo-600 focus:ring-ring border-border rounded"
                />
                <label
                  htmlFor="remember_me"
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-3 gap-3">
              <div className="h-full">
                <a
                  href="#"
                  className="h-full w-full flex items-center justify-center px-8 py-3 border border-border rounded-md shadow-sm text-sm font-medium text-foreground/80 bg-background hover:bg-muted/30"
                >
                  <Image
