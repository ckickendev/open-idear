      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex items-end justify-between mb-10">
          <div>
            ...
            <h2 className="text-3xl font-extrabold text-foreground mb-1.5">
              Khóa học mới nhất
            </h2>
        ...
        >
          ...
          <button
            onClick={() => scroll("left")}
            className="absolute -left-4 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-background/95 backdrop-blur border border-border text-foreground/80 rounded-full flex items-center justify-center opacity-0 group-hover/carousel:opacity-100 transition-all duration-300 hover:bg-violet-50 hover:border-violet-300 hover:text-violet-600 shadow-xl cursor-pointer"
            aria-label="Previous"
          >
            <ChevronLeft size={22} />
          </button>
            ...
            {courses.map((course) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {/* Thumbnail */}
                    <div className="relative aspect-video overflow-hidden rounded-2xl mb-3.5 bg-muted shadow-sm group-hover:shadow-xl transition-all duration-300">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-3">
                        <span className="text-white text-xs font-semibold bg-background/20 backdrop-blur-sm px-3 py-1.5 rounded-full">
                          Xem khóa học →
                        </span>
                      </div>
                    </div>
                    ...
                    {/* Course Info */}
                    <h3 className="font-bold text-[15px] leading-snug text-foreground mb-1.5 line-clamp-2 group-hover:text-violet-700 transition-colors duration-200 min-h-[2.7em]">
                      {course.title}
                    </h3>
          ...
          <button
            ...
            className="absolute -right-4 top-1/2 -translate-y-1/2 z-10 w-12 h-12 bg-background/95 backdrop-blur border border-border text-foreground/80 rounded-full flex items-center justify-center opacity-0 group-hover/carousel:opacity-100 transition-all duration-300 hover:bg-violet-50 hover:border-violet-300 hover:text-violet-600 shadow-xl cursor-pointer"
            aria-label="Next"
          >
